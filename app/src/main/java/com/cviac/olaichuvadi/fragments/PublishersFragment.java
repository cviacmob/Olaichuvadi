...
public class PublishersFragment extends Fragment {
    ...
    private void shrd_item() {
        ...
        AuthorsInfo au1 = new AuthorsInfo("Marvel Comics", R.mipmap.ic);
        authr.add(au1);

        AuthorsInfo au2 = new AuthorsInfo("Tata Publications", R.mipmap.ic);
        authr.add(au2);

        AuthorsInfo au3 = new AuthorsInfo("Tamil Publications 1", R.mipmap.ic);
        authr.add(au3);

        AuthorsInfo au4 = new AuthorsInfo("Tamil Publications 2", R.mipmap.ic);
        authr.add(au4);

        AuthorsInfo au5 = new AuthorsInfo("Tamil Publications 3", R.mipmap.ic);
        authr.add(au5);

        AuthorsInfo au6 = new AuthorsInfo("Tamil Publications 4", R.mipmap.ic);
        authr.add(au6);
    }
